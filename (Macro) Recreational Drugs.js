...
let ddInitial1 = `<form action="/action_page.php">
                    ...
                    <select name="narcotics" id="narcotics"> 
                        ...
                        <option value="aberration-ichor">Aberration Ichor</option>
                        <option value="liquid-construct">Liquid Construct</option>
                        <option value="dragon-scale-powder">Dragon Scale Powder</option>
                        <option value="concentrated-elemental-essence">Concentrated Elemental Essence</option>
                        <option value="fey-bone-powder">Fey Bone Powder</option>
                        <option value="fiend-ichor">Fiend Ichor</option>
                        <option value="git-biggie">Git Biggie</option>
                        <option value="ooze-slime">Ooze Slime</option>
                        <option value="undead-flesh">Undead Flesh</option>
                    </select>
                </form>`;
